...
public class AssistantVoice : MonoBehaviour
{
    ...
    private bool _playedAttention = false;
    private bool _playedStart = false;
    private bool _playedArmsUp = false;
    private bool _playedPressStartButton = false;
    private bool _playedAfterPatientFirstSymptoms = false;
    private bool _playedBookInformation = false;
    private bool _playedUnlockedNewQuestion = false;
    private bool _playedUnlockedNewHint = false;
    private bool _playedMedication = false;
    private bool _playedPrintTranscription = false;
    private bool _playedDiagnostic = false;
    private bool _playedUnlockedNewHintAndQuestion = false;
    private bool _playedWip = false;
